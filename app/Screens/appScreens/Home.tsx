...
const styles = StyleSheet.create({
  ...
  favoriteButton: {
    ...
    top: 8,
    left: 8,
    width: 24, // Largura do botão de favoritos
    height: 24, // Altura do botão de favoritos
    justifyContent: "center",
    alignItems: "center",
  },
  favoriteIcon: {
  ...
  favoriteCircle: {
    width: 30, // Diâmetro do círculo
    height: 30, // Diâmetro do círculo
    borderRadius: 18, // Metade da largura ou altura para criar um círculo
    backgroundColor: "white",
    position: "absolute",
    zIndex: 0,
  },
